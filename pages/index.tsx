...
export default function Dashboard() {
  ...
  return (
    <Flex>
      ...
      {/* Main Content */}
      <Box w="80%" p="4">
        <Text fontSize="xl">Welcome Back, Haseena!</Text>
        <Flex justify="space-between" mt="4">
          <Box>
            <Text>Projects</Text>
            <Text>Ongoing</Text>
          </Box>
          <Button colorScheme="blue">Create a Project</Button>
        </Flex>
        ...
        <Grid templateColumns="repeat(3, 1fr)" gap={6} mt="6">
          {projects.map(project => (
            <GridItem key={project._id} bg="gray.100" p="4" borderRadius="md">
              ...
              <Text>{project.milestone}</Text>
              <Progress value={project.progress} size="sm" mt="2" />
            </GridItem>
          ))}
        </Grid>
      </Box>
